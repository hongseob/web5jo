						...
						<div class="col-12 col-lg-8 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Campaign Approve List</h5>
								</div>
								<!-- 검색 영역 START-->
								<div id="search_campaign_approve" style="padding:3px">
									<select id="search_campaign_approve_select" class="form-select mb-3" style="width:13%; height:100%">
	          							<option selected>캠페인 이름</option>
	          							<option>등록자</option>
	         							<option>날짜</option>
	        						</select>
									<input type="text" id="search_campaign_approve_text" class="form-control" placeholder="캠페인 이름을 입력하세요." style="width:80%; height:100%">
									<button id="search_campaign_approve_button" class="btn btn-primary" style="width:7%" onclick="logList_ajax(1)">검색</button>
								</div>
								<!-- 검색 영역 END -->
...
<%-- 									<tbody>
									<!-- bg-warning 노 bg-success 초 bg-danger 빨 -->
										<c:forEach var="item" items="${list}" varStatus="status">
											<tr onclick="selectCampaginInfo(${item.cId})">
												...
												<td><span class="badge btn-secondary">approve</span></td>
	...
	<script src="/main/js/admin/campaignMenu2.js"></script>
