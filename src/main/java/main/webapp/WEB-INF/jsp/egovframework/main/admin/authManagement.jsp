						...
						<div class="col-12 col-lg-8 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Auth Member List</h5>
								</div>
...
<!-- 											<hr class="my-0" />
										...
										<button class="btn btn-info" onclick="approveNormalMember()">일반 사용자 변경</button>
	...
	<script src="/main/js/admin/userMenu2.js"></script>
