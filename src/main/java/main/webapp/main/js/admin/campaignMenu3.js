...
function logList_ajax(i){
   ...
   var searchTitle=$('#search_campaign_refuse_select').val();
   var searchCont=$('#search_campaign_refuse_text').val();
   ...
   //ajax 전송
   $.ajax({
      url : '/admin/ajax/campaignRefuseList.do',
      data : data,
      dataType : 'json',
      ...
      success : function(data) {
         ...
         for(var idx in data.accessLogList){
            ...
            contHTML+='<td><span class="badge bg-danger">refused</span></td>';
