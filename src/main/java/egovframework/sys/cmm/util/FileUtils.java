...
public class FileUtils {
	...
	public List<Map<String, Object>> parseInsertFileInfo(
			MultipartHttpServletRequest mpRequest, String filePath) throws Exception{
		...
		while(iterator.hasNext()) {
			...
			if(multipartFile.isEmpty() == false) {
				...
				listMap.put("file_svr_name", storedFileName);
	...
	public List<Map<String, Object>> parseUpdateFileInfo(
			MultipartHttpServletRequest mpRequest, String filePath, Integer campaignId) throws Exception{
