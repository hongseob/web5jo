...
function logList_ajax(i){
   ...
   var searchTitle=$('#search_campaign_approve_select').val();
   var searchCont=$('#search_campaign_approve_text').val();
   ...
   //ajax 전송
   $.ajax({
      url : '/admin/ajax/campaignApproveList.do',
      data : data,
      dataType : 'json',
      ...
      success : function(data) {
         ...
         for(var idx in data.accessLogList){
            ...
            contHTML+='<td><span class="badge btn-secondary">approve</span></td>';
