...
function logList_ajax(i){
   ...
   var searchTitle=$('#search_campaign_index_select').val();
   var searchCont=$('#search_campaign_index_text').val();
   ...
   $.ajax({
      ...
      success : function(data) {
         ...
         for(var idx in data.accessLogList){
            ...
            contHTML+='<td><span class="badge bg-warning">application</span></td>';
