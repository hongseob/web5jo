...
function logList_ajax(i){
   ...
   var searchTitle=$('#search_campaign_progress_select').val();
   var searchCont=$('#search_campaign_progress_text').val();
   ...
   //ajax 전송
   $.ajax({
      url : '/admin/ajax/campaignProgressList.do',
      data : data,
      dataType : 'json',
      ...
      success : function(data) {
         ...
         for(var idx in data.accessLogList){
            var ListHTML='<tr class="odd gradeX" onclick="selectCampaginInfo( ' + accessLogList[idx].cId + ')">';
            var contHTML='<td>'+accessLogList[idx].cNm+'</td>';
            contHTML+='<td>'+accessLogList[idx].stDate+'</td>';
            contHTML+='<td>'+accessLogList[idx].edDate+'</td>';
            contHTML+='<td><span class="badge bg-success">Progress</span></td>';
            contHTML+='<td>'+accessLogList[idx].uId+'</td>';
            ListHTML+=contHTML;
            ListHTML+='</tr>';
